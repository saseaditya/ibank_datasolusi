...
<head>
  ...
  <link href="{{ asset('assets/admin/css/highcharts.css') }}" rel="stylesheet" />
...
<body class="">
  ...
  <div class="wrapper ">
    ...
    @yield('modal')
    <div class="sidebar" data-color="red-primary" data-background-color="black" data-image="{{ asset('assets/admin/img/sidebar-1.jpg') }}">
      <!--
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                            <a class="dropdown-item" href="{{ route('prosesLogout') }}">Log out</a>
                        </div>
                    </li>
                </ul>
            </div>
...
{{--                </div>--}}
  ...
  <!-- <script src="{{ asset('assets/admin/js/plugins/jquery.dataTables-quickly.min.js') }}"></script> -->
  ...
  <script src="{{ asset('assets/admin/js/core/core.js') }}"></script>
  ...
  <script src="{{ asset('assets/admin/js/main.js?v=2.1.0') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/admin/js/highcharts.js') }}" type="text/javascript"></script>
  ...
  <script src="{{ asset('assets/admin/plugins/ckeditor_full_v2/ckeditor.js') }}"></script>
